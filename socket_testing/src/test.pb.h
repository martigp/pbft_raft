...
/* @@protoc_insertion_point(class_definition:candy.Message) */ {
 public:
 ...
 private:
  ...
  static ::absl::string_view FullMessageName() { return "candy.Message"; }
 ...
 public:
  ...
  public:
  // @@protoc_insertion_point(class_scope:candy.Message)
 private:
  class _Internal;
...
inline const std::string& Message::sender() const
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_get:candy.Message.sender)
...
inline PROTOBUF_ALWAYS_INLINE void Message::set_sender(Arg_&& arg,
  ...
  // @@protoc_insertion_point(field_set:candy.Message.sender)
}
inline std::string* Message::mutable_sender() ABSL_ATTRIBUTE_LIFETIME_BOUND {
  std::string* _s = _internal_mutable_sender();
  // @@protoc_insertion_point(field_mutable:candy.Message.sender)
  return _s;
}
...
inline std::string* Message::release_sender() {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  // @@protoc_insertion_point(field_release:candy.Message.sender)
...
inline void Message::set_allocated_sender(std::string* value) {
  ...
  // @@protoc_insertion_point(field_set_allocated:candy.Message.sender)
}
...
inline const std::string& Message::msg() const
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_get:candy.Message.msg)
...
inline PROTOBUF_ALWAYS_INLINE void Message::set_msg(Arg_&& arg,
  ...
  // @@protoc_insertion_point(field_set:candy.Message.msg)
}
inline std::string* Message::mutable_msg() ABSL_ATTRIBUTE_LIFETIME_BOUND {
  std::string* _s = _internal_mutable_msg();
  // @@protoc_insertion_point(field_mutable:candy.Message.msg)
  return _s;
}
...
inline std::string* Message::release_msg() {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  // @@protoc_insertion_point(field_release:candy.Message.msg)
...
inline void Message::set_allocated_msg(std::string* value) {
  ...
  #endif  // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:candy.Message.msg)
}
