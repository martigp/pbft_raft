...
class NetworkService {
 ...
 private:
   ...
   */
  void handleReceiveEvent(int receiveSocketFd, uint64_t eventInformation,
                          bool isListenSocket);
   ...
   */
  void populateSockAddr(const std::string& addr, struct sockaddr_in* sockaddr);
   ...
   */
  std::unordered_map<std::string, std::shared_ptr<ConnectionState>>
      connectionStateMap;
