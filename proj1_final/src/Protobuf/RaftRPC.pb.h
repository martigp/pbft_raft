...
inline ::uint64_t RPC_AppendEntries_Request::requestid() const {
  // @@protoc_insertion_point(field_get:Raft.RPC.AppendEntries.Request.requestID)
  return _internal_requestid();
}
inline void RPC_AppendEntries_Request::set_requestid(::uint64_t value) {
  _internal_set_requestid(value);
  // @@protoc_insertion_point(field_set:Raft.RPC.AppendEntries.Request.requestID)
}
...
inline ::uint64_t RPC_AppendEntries_Response::requestid() const {
  // @@protoc_insertion_point(field_get:Raft.RPC.AppendEntries.Response.requestID)
  return _internal_requestid();
}
inline void RPC_AppendEntries_Response::set_requestid(::uint64_t value) {
  _internal_set_requestid(value);
  // @@protoc_insertion_point(field_set:Raft.RPC.AppendEntries.Response.requestID)
}
